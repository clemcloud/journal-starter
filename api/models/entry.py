...
EntryField = Annotated[str, StringConstraints(strip_whitespace=True, min_length=1, max_length=256)]
...
class Entry(BaseModel):
    ...
    work: EntryField = Field(description="What did you work on today?")
    struggle: EntryField = Field(description="What's one thing you struggled with today?")
    intention: EntryField = Field(description="What will you study/work on tomorrow?")
    created_at: datetime = Field(
        default_factory=lambda: datetime.now(UTC),
